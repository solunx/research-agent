...
**Laatste commit:** `1f0557e` / pin `c4e186e`. Werkboom: Open #28 PDF-catch (nog uncommitted). **#26 OPEN.** Docker: altijd `docker compose build` vóór run.

**Open (top 3):**
1. **#26** — unbind/switch live nooit gezien (`083112Z` hypothese; `093236Z`/`102344Z`/`111714Z` geen event). Offline groen. Open laten.
2. **#24b** — nog actief (search = één blok + één `"pdf"`-affordance). Niet `html_b2`.
